...
function ci(t){return null==t}ri.styles=s`
  ...
  `,t([ut({attribute:!1})],ua.prototype,"hass",void 0),t([ht()],ua.prototype,"_config",void 0),t([ht()],ua.prototype,"_card",void 0),ua=t([ct("material-dashboard-card")],ua);const ha={type:"custom:material-dashboard-card"};function pa(t,e){const i=t.target.getAttribute("configValue"),n=t.detail.value;i&&e._config[i]!==n&&(e._config=Object.assign(Object.assign({},e._config),{[i]:n}),e.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e._config}})))}let ma=class extends st{constructor(){super(...arguments),this._config=ha,this._valueChanged=t=>{var e,i;const n=t.target,a=n.getAttribute("configValue"),o=t instanceof CustomEvent&&void 0!==(null===(e=t.detail)||void 0===e?void 0:e.value)?t.detail.value:null!==(i=n.checked)&&void 0!==i?i:n.value;a&&this._config[a]!==o&&(this._config=Object.assign(Object.assign({},this._config),{[a]:o}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}}setConfig(t){this._config=Object.assign({},t)}_navigationChangedOld(t){const e=t.target.getAttribute("configValue"),i=t.detail.value;e&&this._config[e]!==i&&(this._config=Object.assign(Object.assign({},this._config),{[e]:i}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}async firstUpdated(){const t=await window.loadCardHelpers(),e=await t.createCardElement({type:"entities",entities:[]});await e.constructor.getConfigElement()}render(){var t,e,i;return this._config&&this.hass?(this._config.default_action=null===(t=this._config.default_action)||void 0===t||t,V`
      <div class="form">
        ...
        <div class="switch-row">
          ...
          >
          <ha-switch
            .checked=${null===(e=this._config.default_action)||void 0===e||e}
  ...
  `,t([ut({attribute:!1})],Oa.prototype,"hass",void 0),t([ht()],Oa.prototype,"_config",void 0),t([ht()],Oa.prototype,"_card",void 0),Oa=t([ct("material-lights-card")],Oa);const Sa={type:"custom:material-control-card",on_text:"Lights on",off_text:"Lights off"};let Ma=class extends st{constructor(){super(...arguments),this._config=Sa,this._valueChanged=t=>{var e,i;const n=t.target,a=n.getAttribute("configValue"),o=t instanceof CustomEvent&&void 0!==(null===(e=t.detail)||void 0===e?void 0:e.value)?t.detail.value:null!==(i=n.checked)&&void 0!==i?i:n.value;a&&this._config[a]!==o&&(this._config=Object.assign(Object.assign({},this._config),{[a]:o}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}}setConfig(t){this._config=Object.assign({},t)}async firstUpdated(){const t=await window.loadCardHelpers(),e=await t.createCardElement({type:"entities",entities:[]});await e.constructor.getConfigElement()}render(){return this._config&&this.hass?V`
      <div class="form">
        <span class="text-label"
    ...
    `:V``}};function Ia(t){const e=document.createElement("a");e.href=t,e.target="_blank",e.rel="noopener noreferrer",document.body.appendChild(e),e.click(),document.body.removeChild(e)}function Na(){Ia(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.google.android.apps.chromecast.app":/iPhone|iPad|iPod/i.test(t)?"googlehome://":"https://home.google.com/"}())}function Pa(){Ia(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.google.android.youtube":/iPhone|iPad|iPod/i.test(t)?"youtube://":"https://www.youtube.com/"}())}function ja(){Ia(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.spotify.music":/iPhone|iPad|iPod/i.test(t)?"spotify://":"https://open.spotify.com/"}())}function La(){Ia(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.netflix.mediaclient":/iPhone|iPad|iPod/i.test(t)?"nflx://":"https://www.netflix.com/"}())}function Ra(){Ia(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.twitch.tv":/iPhone|iPad|iPod/i.test(t)?"twitch://":"https://www.twitch.tv/"}())}Ma.styles=s`
    .form {
      display: flex;
      flex-direction: column;
      gap: 12px;
  ...
  `,t([ut({attribute:!1})],Va.prototype,"hass",void 0),t([ht()],Va.prototype,"_config",void 0),t([ht()],Va.prototype,"_card",void 0),Va=t([ct("material-menu-card")],Va);let Ha=class extends st{constructor(){super(...arguments),this._config=Fa,this._configLoaded=!1}setConfig(t){this._config=Object.assign(Object.assign({},Fa),t),this._configLoaded=!0}_valueChanged(t){var e,i;const n=t.target,a=null==n?void 0:n.getAttribute("configValue"),o=void 0!==(null===(e=t.detail)||void 0===e?void 0:e.value)?t.detail.value:null!==(i=n.checked)&&void 0!==i?i:n.value;a&&this._config[a]!==o&&(this._config=Object.assign(Object.assign({},this._config),{[a]:o}),this._fireConfigChanged())}_fireConfigChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return this._config&&this.hass?V`
    ...
    `}_renderActionFields(t,e,i){const n=e;switch(t){case"navigate":return V`
        ...
        `;case"call-service":return V`
          ...
          ></ha-textarea>
        `;default:return V``}}};var Ya;Ha.styles=s`
    .form {
      display: flex;
      flex-direction: column;
      gap: 12px;
