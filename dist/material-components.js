...
function li(t){return null==t}ci.styles=s`
        ...
        ${o?V`
            ...
            `:V`
              ...
              >
                ...
                >
                  ${c||l?qe(this._config.fix_temperature,n.attributes.temperature):ye("common.off")}
                </div>
                ${c||l?V`<button
  ...
  `,t([ut({attribute:!1})],Ma.prototype,"hass",void 0),t([ht()],Ma.prototype,"_config",void 0),t([ht()],Ma.prototype,"_card",void 0),Ma=t([ct("material-lights-card")],Ma);const Ia={type:"custom:material-control-card",on_text:"Lights on",off_text:"Lights off"};let Na=class extends st{constructor(){super(...arguments),this._config=Ia}setConfig(t){this._config=Object.assign({},t)}async firstUpdated(){const t=await window.loadCardHelpers(),e=await t.createCardElement({type:"entities",entities:[]});await e.constructor.getConfigElement()}render(){return this._config&&this.hass?V`
    ...
    `:V``}};function Pa(t){const e=document.createElement("a");e.href=t,e.target="_blank",e.rel="noopener noreferrer",document.body.appendChild(e),e.click(),document.body.removeChild(e)}function La(){Pa(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.google.android.apps.chromecast.app":/iPhone|iPad|iPod/i.test(t)?"googlehome://":"https://home.google.com/"}())}function ja(){Pa(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.google.android.youtube":/iPhone|iPad|iPod/i.test(t)?"youtube://":"https://www.youtube.com/"}())}function Ra(){Pa(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.spotify.music":/iPhone|iPad|iPod/i.test(t)?"spotify://":"https://open.spotify.com/"}())}function Fa(){Pa(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.netflix.mediaclient":/iPhone|iPad|iPod/i.test(t)?"nflx://":"https://www.netflix.com/"}())}function za(){Pa(function(){const t=navigator.userAgent||"";return/Android/i.test(t)?"app://com.twitch.tv":/iPhone|iPad|iPod/i.test(t)?"twitch://":"https://www.twitch.tv/"}())}Na.styles=s`
    .form {
      display: flex;
      flex-direction: column;
      gap: 12px;
