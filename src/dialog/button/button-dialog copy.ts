...
@customElement("button-dialog-copy")
export class ButtonDialogCopy extends LitElement {
  ...
  render() {
    ...
    const icon = "m3r:power-settings-new";
      ...
      >
        ...
        <div class="content">
          <div class="toggle-container">
            <div
              class="google-toggle ${isDeviceTurnOn ? "on" : "off"} ${theme}"
  ...
  static styles = css`
    ...
    * END Menu Cards
    * ------------------------------------ */
    /* Container per centrare il tutto */
    .toggle-container {
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    .google-toggle.on {
      background-color: #d2e3fc; /* Azzurro Google Home */
    }

    /* Traccia interna per il movimento */
    .slider-track {
      width: 100%;
      height: 100%;
      position: relative;
    ...
    .google-toggle.off .slider-track {
      justify-content: flex-end;
    }

    .google-toggle.on .slider-track {
      justify-content: flex-start;
    }

    /* Il bottone scorrevole (Thumb) */
    .slider-thumb {
      width: 100%;
      height: 48%;
      display: flex;
    ...
    .google-toggle.off .slider-thumb {
      ...
      border-radius: 30px; /* Più squadrato come in foto */
    }

    .google-toggle.on .slider-thumb {
      background-color: #a8c7fa; /* Blu più scuro per il thumb */
      border-radius: 50px;
      height: 105px;
    }
